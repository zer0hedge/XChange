...
public class OkCoinStreamingTradeService extends OkCoinBaseStreamingService implements StreamingTradeService {
	...
	public String placeLimitOrder(LimitOrder limitOrder) {
		...
		while (true) {
			try {
				OkCoinPlaceLimitOrderRequest request = new OkCoinPlaceLimitOrderRequest(limitOrder, channelProvider,
	...
	@Override
	public void cancelOrder(String orderId, CurrencyPair currencyPair) throws ExchangeException, NotAvailableFromExchangeException,
		...
		while (true) {
			try {
				OkCoinCancelOrderRequest request = new OkCoinCancelOrderRequest(orderId,
						currencyPair.toString().replace("/", "_").toLowerCase(),
						channelProvider, apikey, signatureCreator);
				newRequestsQueue.put(request);
				request.get();
	...
	@Override
	public LimitOrder getOrder(String orderId, CurrencyPair currencyPair) throws ExchangeException, NotAvailableFromExchangeException,
			NotYetImplementedForExchangeException, IOException {
